...
class ReminderTable {
    companion object {
        ...
        fun insertreminder(db:SQLiteDatabase,reminder: Remainder){
        ...
        fun getAllTask(db:SQLiteDatabase): ArrayList<Remainder> {

            val reminders = arrayListOf<Remainder>()
