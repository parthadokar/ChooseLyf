package com.example.chatbotui.bmi;
...
public class BmiCalMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bmicalmainactivity);
        ...
        mcalculatebmi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(intweight==0|| intweight<0)
                {
                    ...
                    Intent intent = new Intent(BmiCalMainActivity.this, BmiCalActivity.class);
